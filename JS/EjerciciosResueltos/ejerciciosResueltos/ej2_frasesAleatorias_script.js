...
function cambiarTexto() {
  let indice = Math.floor(Math.random() * frasesFrikisInformatica.length);    // Obtener un índice aleatorio del array de frases
   let texto = document.getElementById("texto-informatica");                  // Obtener el elemento de texto
  texto.textContent = frasesFrikisInformatica[indice];                        // Cambiar el contenido del elemento con una frase aleatoria
}

// Asignar evento al botón
document.addEventListener("DOMContentLoaded", function() {
  var boton = document.getElementById("ver-mas-boton");
